...
const BasePage = props => {
  ...
  header, 
  title = "Countertop",  
  metaDescription = "Best countertop material is granitie, marble and quartz. Experienced countertop installation team is working for you. Get free estimation for your remodeling.",
  canonicalPath,
  children } = props;
  ...
  return (
    ...
    <Head>
      ...
      content={metaDescription}/>
        ...
        <meta property="og:image" key="og:image" content={`${process.env.BASE_URL}/images/banner.jpg`} />
