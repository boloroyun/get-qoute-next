...
const Blogs = ({ blogs }) => {
  ...
  return (
    <BaseLayout
      ...
      <BasePage
      title="The newest blogs - Kitchen Bathroom Remodeling"
      metaDescription="News and helpful information about kitchen and bathroom remodeling. There are lots of ideas about remodeling your home. "
        className="blog-body">
        <Row>
          {
            blogs.map(blog =>
